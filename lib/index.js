(function (global, factory) {
    ...
    var Socket = exports.Socket = function Socket(_ref) {
        ...
        this.attemptReconnect = function () {
            var time = _this.auto_reconnect.every ? _this.auto_reconnect.every : 2000;
        ...
        this.request = function (event, params_or_cb_if_no_params, cb_if_params) {
            ...
            var request_id = (0, _utils.uniqueID)();

            var request_data = Object.assign({ type: 'request' }, params, { request_id: request_id });
            ...
            var response_listener_event = event + ("_" + request_id + "_response");

            _this.on(response_listener_event, cb);
        };
        ...
        this.on = function (event, cb) {
            ...
            var event_listener = { name: name, fn: cb };
